...
This is a generated Python SDK for Profound, produced by the Scalar SDK Generator (https://scalar.com).
...
If the issue is in the Profound API or service rather than in this SDK, report it through the security process Profound has published.
