...
class TestProfound:
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(
            TypeError,
            match="Could not resolve authentication method. Expected either access_token or api_key to be set. Or for one of the `Authorization` or `X-API-Key` headers to be explicitly omitted",
        ):
    ...
    def test_hardcoded_query_params_in_url(self, client: Profound) -> None:
...
class TestAsyncProfound:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncProfound) -> None:
