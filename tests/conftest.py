...
def client(request: FixtureRequest) -> Iterator[Profound]:
    ...
    with Profound(base_url=base_url, header_api_key=header_api_key, _strict_response_validation=strict) as client:
        yield client
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncProfound]:
    ...
    async with AsyncProfound(
        base_url=base_url, header_api_key=header_api_key, _strict_response_validation=strict, http_client=http_client
    ) as client:
        yield client
