...
from ...types.knowledge_bases import folder_create_params
from ...types.knowledge_bases.folder_delete_response import FolderDeleteResponse
from ...types.knowledge_bases import folder_delete_params
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({"organization_id": organization_id}, folder_create_params.FolderCreateParams)),
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({"organization_id": organization_id}, folder_delete_params.FolderDeleteParams)),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=await async_maybe_transform({"organization_id": organization_id}, folder_create_params.FolderCreateParams)),
            cast_to=FolderCreateResponse,
        )
    ...
    async def delete(
        ...
        *,
        ...
        return await self._delete(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=await async_maybe_transform({"organization_id": organization_id}, folder_delete_params.FolderDeleteParams)),
            cast_to=FolderDeleteResponse,
        )
