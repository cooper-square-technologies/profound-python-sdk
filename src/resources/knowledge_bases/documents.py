...
from ...types.knowledge_bases import document_create_params
from ...types.knowledge_bases.document_update_response import DocumentUpdateResponse
from ...types.knowledge_bases import document_update_params
from ...types.knowledge_bases.document_delete_response import DocumentDeleteResponse
from ...types.knowledge_bases import document_delete_params
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({"organization_id": organization_id}, document_create_params.DocumentCreateParams)),
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({"organization_id": organization_id}, document_update_params.DocumentUpdateParams)),
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({"organization_id": organization_id}, document_delete_params.DocumentDeleteParams)),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=await async_maybe_transform({"organization_id": organization_id}, document_create_params.DocumentCreateParams)),
            cast_to=DocumentCreateResponse,
        )
    ...
    async def update(
        ...
        *,
        ...
        return await self._put(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=await async_maybe_transform({"organization_id": organization_id}, document_update_params.DocumentUpdateParams)),
            cast_to=DocumentUpdateResponse,
        )
    ...
    async def delete(
        ...
        *,
        ...
        return await self._delete(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=await async_maybe_transform({"organization_id": organization_id}, document_delete_params.DocumentDeleteParams)),
            cast_to=DocumentDeleteResponse,
        )
