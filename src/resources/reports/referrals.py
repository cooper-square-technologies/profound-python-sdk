...
from ...types.reports import referral_create_report_v1_v1_reports_post_params
from ...types.report_response import ReportResponse
from ...types.pagination import Pagination
from ...types.path_filter import PathFilter
from ...types.reports import referral_create_report_v2_v2_reports_post_params
...
class ReferralsResource(SyncAPIResource):
    ...
    def create_report_v1_v1_reports_post(
        ...
        *,
        ...
        dimensions: Iterable[Literal["date", "path", "referral_source"]] | Omit = omit,
        metrics: Iterable[Literal["visits", "last_visit"]],
        ...
        metric_filters: Iterable[referral_create_report_v1_v1_reports_post_params.MetricFilter] | Omit = omit,
        ...
        return self._post(
            ...
            referral_create_report_v1_v1_reports_post_params.ReferralCreateReportV1V1ReportsPostParams,
        ),
    ...
    def create_report_v2_v2_reports_post(
        ...
        *,
        ...
        dimensions: Iterable[Literal["date", "hour", "path", "referral_source", "referral_type"]] | Omit = omit,
        metrics: Iterable[Literal["visits", "last_visit"]],
        order_by: Dict[str, Literal["asc", "desc"]] | Omit = omit,
        pagination: Pagination | Omit = omit,
        domain: str,
        ...
        end_date: Union[str, datetime] | Omit = omit,
        organization_id: Optional[str] | Omit = omit,
        metric_filters: Iterable[referral_create_report_v2_v2_reports_post_params.MetricFilter] | Omit = omit,
        filters: Iterable[object] | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        ...
        return self._post(
            ...
            referral_create_report_v2_v2_reports_post_params.ReferralCreateReportV2V2ReportsPostParams,
        ),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=ReportResponse,
        )
...
class AsyncReferralsResource(AsyncAPIResource):
    ...
    async def create_report_v1_v1_reports_post(
        ...
        *,
        ...
        Example:
            ```python
            referral = await client.reports.referrals.create_report_v1_v1_reports_post(
                date_interval="day",
                dimensions=[],
                metrics=[],
                order_by={},
    ...
    async def create_report_v2_v2_reports_post(
        ...
        *,
        ...
        Example:
            ```python
            referral = await client.reports.referrals.create_report_v2_v2_reports_post(
                date_interval="day",
                dimensions=[],
                metrics=[],
                order_by={},
...
class ReferralsResourceWithRawResponse:
    def __init__(self, referrals: ReferralsResource) -> None:
        ...
        self.create_report_v1_v1_reports_post = to_raw_response_wrapper(
            referrals.create_report_v1_v1_reports_post,
        )
        self.create_report_v2_v2_reports_post = to_raw_response_wrapper(
            referrals.create_report_v2_v2_reports_post,
        )
