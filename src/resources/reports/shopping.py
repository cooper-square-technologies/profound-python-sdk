...
from ...types.reports.shopping_visibility_response import ShoppingVisibilityResponse, Data
...
from ...types.reports.brand_name_filter import BrandNameFilter
from ...types.reports.merchant_name_filter import MerchantNameFilter
from ...types.reports.product_name_filter import ProductNameFilter
from ...types.pagination import Pagination
from ...types.reports import shopping_visibility_params
from ...types.reports.shopping_item_visibility_response import ShoppingItemVisibilityResponse, Data
from ...types.region_id_filter import RegionIdFilter
from ...types.model_id_filter import ModelIdFilter
from ...types.topic_id_filter import TopicIdFilter
from ...types.tag_id_filter import TagIdFilter
...
from ...types.reports.product_name_filter import ProductNameFilter
from ...types.pagination import Pagination
from ...types.reports import shopping_item_visibility_params
from ...types.reports.shopping_merchant_distribution_response import ShoppingMerchantDistributionResponse, Data
from ...types.region_id_filter import RegionIdFilter
from ...types.model_id_filter import ModelIdFilter
from ...types.topic_id_filter import TopicIdFilter
from ...types.tag_id_filter import TagIdFilter
...
from ...types.reports.product_name_filter import ProductNameFilter
from ...types.pagination import Pagination
from ...types.reports import shopping_merchant_distribution_params
from ...types.reports.shopping_merchant_visibility_by_brand_response import ShoppingMerchantVisibilityByBrandResponse, Data
from ...types.region_id_filter import RegionIdFilter
from ...types.model_id_filter import ModelIdFilter
from ...types.topic_id_filter import TopicIdFilter
from ...types.tag_id_filter import TagIdFilter
...
from ...types.reports.product_name_filter import ProductNameFilter
from ...types.pagination import Pagination
from ...types.reports import shopping_merchant_visibility_by_brand_params
from ...types.reports.shopping_merchant_by_items_response import ShoppingMerchantByItemsResponse, Data
from ...types.region_id_filter import RegionIdFilter
from ...types.model_id_filter import ModelIdFilter
from ...types.topic_id_filter import TopicIdFilter
from ...types.tag_id_filter import TagIdFilter
...
from ...types.reports.product_name_filter import ProductNameFilter
from ...types.pagination import Pagination
from ...types.reports import shopping_merchant_by_items_params
from ...types.reports.shopping_all_items_with_merchants_response import ShoppingAllItemsWithMerchantsResponse, Data
from ...types.region_id_filter import RegionIdFilter
from ...types.model_id_filter import ModelIdFilter
from ...types.topic_id_filter import TopicIdFilter
from ...types.tag_id_filter import TagIdFilter
...
from ...types.reports.product_name_filter import ProductNameFilter
from ...types.pagination import Pagination
from ...types.reports import shopping_all_items_with_merchants_params
from ...types.reports.shopping_trigger_rate_response import ShoppingTriggerRateResponse, Data
from ...types.region_id_filter import RegionIdFilter
from ...types.model_id_filter import ModelIdFilter
from ...types.topic_id_filter import TopicIdFilter
from ...types.tag_id_filter import TagIdFilter
...
from ...types.reports.product_name_filter import ProductNameFilter
from ...types.pagination import Pagination
from ...types.reports import shopping_trigger_rate_params
from ...types.reports.shopping_merchant_share_response import ShoppingMerchantShareResponse, Data
from ...types.region_id_filter import RegionIdFilter
from ...types.model_id_filter import ModelIdFilter
from ...types.topic_id_filter import TopicIdFilter
from ...types.tag_id_filter import TagIdFilter
...
from ...types.reports.product_name_filter import ProductNameFilter
from ...types.pagination import Pagination
from ...types.reports import shopping_merchant_share_params
from ...types.reports.shopping_product_merchant_urls_response import ShoppingProductMerchantUrlsResponse, Data
from ...types.reports import shopping_product_merchant_urls_params
from ...types.reports.shopping_executions_response import ShoppingExecutionsResponse, Data
from ...types.region_id_filter import RegionIdFilter
from ...types.model_id_filter import ModelIdFilter
from ...types.topic_id_filter import TopicIdFilter
from ...types.tag_id_filter import TagIdFilter
...
from ...types.reports.product_name_filter import ProductNameFilter
from ...types.pagination import Pagination
from ...types.reports import shopping_executions_params
...
class ShoppingResource(SyncAPIResource):
    ...
    def visibility(
        ...
        *,
        ...
        dimensions: Iterable[Literal["period", "asset_name", "date", "model_id", "topic_id", "region_id", "prompt_id", "prompt"]] | Omit = omit,
        metrics: Iterable[Literal["visibility_score", "share_of_voice", "average_position", "visibility_rank", "average_position_rank", "position1_percentage", "position2_percentage", "position3_percentage", "position_above3_percentage", "total_count"]] | Omit = omit,
    ...
    def item_visibility(
        ...
        *,
        ...
        include_no_tag: bool | Omit = omit,
        exclude_topic_ids: bool | Omit = omit,
        dimensions: Iterable[Literal["period", "product_name", "brand_name", "date", "topic_id", "prompt_id", "prompt", "product_url", "product_image_urls", "product_price"]] | Omit = omit,
        metrics: Iterable[Literal["visibility_score", "share_of_voice", "average_position", "visibility_rank", "position1_percentage", "position2_percentage", "position3_percentage", "position_above3_percentage", "product_rating", "product_num_reviews", "total_count"]] | Omit = omit,
        owned_asset_names: SequenceNotStr[str] | Omit = omit,
    ...
    def merchant_distribution(
        ...
        *,
        ...
        include_no_tag: bool | Omit = omit,
        exclude_topic_ids: bool | Omit = omit,
        dimensions: Iterable[Literal["period", "merchant_name", "date", "owned_asset_name"]] | Omit = omit,
        metrics: Iterable[Literal["offer_count", "product_count", "average_rank", "share_of_offers", "visibility_rank", "total_count"]] | Omit = omit,
        owned_asset_names: SequenceNotStr[str] | Omit = omit,
    ...
    def merchant_visibility_by_brand(
        ...
        *,
        ...
        include_no_tag: bool | Omit = omit,
        exclude_topic_ids: bool | Omit = omit,
        dimensions: Iterable[Literal["period", "merchant_name", "brand_name"]] | Omit = omit,
        metrics: Iterable[Literal["visibility_score", "share_of_voice", "average_position", "visibility_rank", "total_count"]] | Omit = omit,
        owned_asset_names: SequenceNotStr[str] | Omit = omit,
    ...
    def merchant_by_items(
        ...
        *,
        ...
        include_no_tag: bool | Omit = omit,
        exclude_topic_ids: bool | Omit = omit,
        dimensions: Iterable[Literal["period", "merchant_name", "product_name", "brand_name", "product_image_urls", "product_price", "merchant_prices", "has_instant_checkout", "delivery_options", "merchant_url"]] | Omit = omit,
        metrics: Iterable[Literal["merchant_visibility", "product_visibility", "product_rank", "avg_position", "total_count"]] | Omit = omit,
    ...
    def all_items_with_merchants(
        ...
        *,
        ...
        include_no_tag: bool | Omit = omit,
        exclude_topic_ids: bool | Omit = omit,
        dimensions: Iterable[Literal["period", "product_name", "brand_name", "product_url", "product_image_urls", "product_price", "merchant_names", "merchant_prices"]] | Omit = omit,
        metrics: Iterable[Literal["visibility_score", "share_of_voice", "average_position", "visibility_rank", "product_rating", "product_num_reviews", "total_count"]] | Omit = omit,
        owned_asset_names: SequenceNotStr[str] | Omit = omit,
        include_items: SequenceNotStr[str] | Omit = omit,
        search_item: Optional[str] | Omit = omit,
        merchant_filter_type: Literal["any", "all"] | Omit = omit,
    ...
    def trigger_rate(
        ...
        *,
        ...
        include_no_tag: bool | Omit = omit,
        exclude_topic_ids: bool | Omit = omit,
        dimensions: Iterable[Literal["period", "date", "model_id", "topic_id", "region_id", "persona_id", "prompt_id", "prompt"]] | Omit = omit,
        metrics: Iterable[Literal["total_runs", "shopping_triggered_runs", "trigger_rate_percentage"]] | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
    ...
    def merchant_share(
        ...
        *,
        ...
        include_no_tag: bool | Omit = omit,
        exclude_topic_ids: bool | Omit = omit,
        dimensions: Iterable[Literal["period", "topic_id", "prompt_id"]] | Omit = omit,
        metrics: Iterable[Literal["merchant_share"]] | Omit = omit,
    ...
    def executions(
        ...
        *,
        ...
        include_no_tag: bool | Omit = omit,
        exclude_topic_ids: bool | Omit = omit,
        analysis_types: Iterable[Literal["visibility", "sentiment", "sentiment_v2", "accuracy"]] | Omit = omit,
