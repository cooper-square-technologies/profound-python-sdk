...
from ...types.content.optimization_list_response import OptimizationListResponse, ContentOptimizationResponseInfo, OptimizationQuery, ContentOptimization
from ...types.content import optimization_list_params
from ...types.content.optimization_retrieve_response import OptimizationRetrieveResponse, ContentAnalysis, DocumentContent, AeoScore, AeoScoreTargetZone, AnalysisSummary, AnalysisBreakdown, Recommendation, RecommendationImpact, RecommendationSuggestion, AnalysisInputs, TopicInput, PromptInput, UserInput
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({"limit": limit, "offset": offset}, optimization_list_params.OptimizationListParams)),
    ...
    async def list(
        ...
        *,
        ...
        return await self._get(
            path_template("/v1/content/{asset_id}/optimization", **{"asset_id": asset_id}),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=await async_maybe_transform({"limit": limit, "offset": offset}, optimization_list_params.OptimizationListParams)),
            cast_to=OptimizationListResponse,
        )
