...
__all__ = ["ShoppingMerchantDistributionParams", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingMerchantDistributionParams(TypedDict, total=False):
    ...
    dimensions: Iterable[Literal["period", "merchant_name", "date", "owned_asset_name"]]

    metrics: Iterable[Literal["offer_count", "product_count", "average_rank", "share_of_offers", "visibility_rank", "total_count"]]
