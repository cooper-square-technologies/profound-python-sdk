...
__all__ = ["ShoppingTriggerRateQuery", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingTriggerRateQuery(BaseModel):
    ...
    dimensions: Optional[List[Literal["period", "date", "model_id", "topic_id", "region_id", "persona_id", "prompt_id", "prompt"]]] = None

    metrics: Optional[List[Literal["total_runs", "shopping_triggered_runs", "trigger_rate_percentage"]]] = None
