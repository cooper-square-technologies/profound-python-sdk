...
__all__ = ["AccuracyFactcheckSetupStatusV1ReportsFactcheckSetupStatusPostResponse"]


class AccuracyFactcheckSetupStatusV1ReportsFactcheckSetupStatusPostResponse(BaseModel):
