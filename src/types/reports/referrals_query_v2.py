...
__all__ = ["ReferralsQueryV2", "NumericMetricFilter", "ReferralSourceFilter", "ReferralTypeFilter"]


class ReferralTypeFilter(BaseModel):

    field: Literal["referral_type"]
    ...
    value: Union[Literal["internal", "referer", "utm", "none"], List[Literal["internal", "referer", "utm", "none"]]]
...
class ReferralsQueryV2(BaseModel):

    date_interval: Optional[Literal["hour", "day", "week", "month", "quarter", "year", "relative_week"]] = None
    """Date interval for the report. (only used with date dimension)"""

    dimensions: Optional[List[Literal["date", "hour", "path", "referral_source", "referral_type"]]] = None
    ...
    filters: Optional[List[Annotated[Union[PathFilter, ReferralSourceFilter, ReferralTypeFilter], PropertyInfo(discriminator="field")]]] = None
