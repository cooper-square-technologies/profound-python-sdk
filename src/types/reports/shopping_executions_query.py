...
__all__ = ["ShoppingExecutionsQuery", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingExecutionsQuery(BaseModel):
    ...
    analysis_filter_type: Optional[Literal["any", "all"]] = None
