...
__all__ = ["BotsReportQueryV2", "NumericMetricFilter", "BotTypeFilter"]


class BotTypeFilter(BaseModel):

    field: Literal["bot_type"]
    ...
    value: Union[Literal["ai_assistant", "ai_training", "index", "ai_agent"], List[Literal["ai_assistant", "ai_training", "index", "ai_agent"]]]
...
class BotsReportQueryV2(BaseModel):

    date_interval: Optional[Literal["hour", "day", "week", "month", "quarter", "year", "relative_week"]] = None
    """Date interval for the report. (only used with date dimension)"""

    dimensions: Optional[List[Literal["date", "hour", "path", "bot_name", "bot_provider", "bot_type"]]] = None
    ...
    filters: Optional[List[Annotated[Union[PathFilter, BotNameFilter, BotProviderFilter, BotTypeFilter], PropertyInfo(discriminator="field")]]] = None
