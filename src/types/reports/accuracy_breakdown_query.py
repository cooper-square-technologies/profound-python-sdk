...
__all__ = ["AccuracyBreakdownQuery"]


class AccuracyBreakdownQuery(BaseModel):
    ...
    breakdown_by: Optional[Literal["citation", "platform", "topic", "prompt", "tag", "region", "persona"]] = None
    ...
    sort_by: Optional[Literal["citationShare", "accuracy"]] = None
