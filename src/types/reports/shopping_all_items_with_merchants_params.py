...
__all__ = ["ShoppingAllItemsWithMerchantsParams", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingAllItemsWithMerchantsParams(TypedDict, total=False):
    ...
    dimensions: Iterable[Literal["period", "product_name", "brand_name", "product_url", "product_image_urls", "product_price", "merchant_names", "merchant_prices"]]

    metrics: Iterable[Literal["visibility_score", "share_of_voice", "average_position", "visibility_rank", "product_rating", "product_num_reviews", "total_count"]]
