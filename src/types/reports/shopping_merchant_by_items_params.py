...
__all__ = ["ShoppingMerchantByItemsParams", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingMerchantByItemsParams(TypedDict, total=False):
    ...
    dimensions: Iterable[Literal["period", "merchant_name", "product_name", "brand_name", "product_image_urls", "product_price", "merchant_prices", "has_instant_checkout", "delivery_options", "merchant_url"]]

    metrics: Iterable[Literal["merchant_visibility", "product_visibility", "product_rank", "avg_position", "total_count"]]
