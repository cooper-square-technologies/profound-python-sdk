...
__all__ = ["ShoppingAllItemsWithMerchantsQuery", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingAllItemsWithMerchantsQuery(BaseModel):
    ...
    dimensions: Optional[List[Literal["period", "product_name", "brand_name", "product_url", "product_image_urls", "product_price", "merchant_names", "merchant_prices"]]] = None

    metrics: Optional[List[Literal["visibility_score", "share_of_voice", "average_position", "visibility_rank", "product_rating", "product_num_reviews", "total_count"]]] = None
    ...
    rank_by: Optional[Literal["visibility", "average_position", "name"]] = None
