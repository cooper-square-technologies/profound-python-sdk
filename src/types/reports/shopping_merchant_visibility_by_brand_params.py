...
__all__ = ["ShoppingMerchantVisibilityByBrandParams", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingMerchantVisibilityByBrandParams(TypedDict, total=False):
    ...
    dimensions: Iterable[Literal["period", "merchant_name", "brand_name"]]

    metrics: Iterable[Literal["visibility_score", "share_of_voice", "average_position", "visibility_rank", "total_count"]]
