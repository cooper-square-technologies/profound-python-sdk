...
__all__ = ["ShoppingItemVisibilityQuery", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingItemVisibilityQuery(BaseModel):
    ...
    dimensions: Optional[List[Literal["period", "product_name", "brand_name", "date", "topic_id", "prompt_id", "prompt", "product_url", "product_image_urls", "product_price"]]] = None

    metrics: Optional[List[Literal["visibility_score", "share_of_voice", "average_position", "visibility_rank", "position1_percentage", "position2_percentage", "position3_percentage", "position_above3_percentage", "product_rating", "product_num_reviews", "total_count"]]] = None
    ...
    merchant_filter_type: Optional[Literal["any", "all"]] = None
