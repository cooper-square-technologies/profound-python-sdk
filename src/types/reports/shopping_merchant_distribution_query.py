...
__all__ = ["ShoppingMerchantDistributionQuery", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingMerchantDistributionQuery(BaseModel):
    ...
    dimensions: Optional[List[Literal["period", "merchant_name", "date", "owned_asset_name"]]] = None

    metrics: Optional[List[Literal["offer_count", "product_count", "average_rank", "share_of_offers", "visibility_rank", "total_count"]]] = None

    owned_asset_names: Optional[List[str]] = None

    search_merchant: Optional[str] = None
