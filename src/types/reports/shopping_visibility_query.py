...
__all__ = ["ShoppingVisibilityQuery", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingVisibilityQuery(BaseModel):
    ...
    dimensions: Optional[List[Literal["period", "asset_name", "date", "model_id", "topic_id", "region_id", "prompt_id", "prompt"]]] = None

    metrics: Optional[List[Literal["visibility_score", "share_of_voice", "average_position", "visibility_rank", "average_position_rank", "position1_percentage", "position2_percentage", "position3_percentage", "position_above3_percentage", "total_count"]]] = None

    owned_asset_names: Optional[List[str]] = None

    search_asset: Optional[str] = None

    include_asset: Optional[str] = None

    include_asset_only: Optional[bool] = None

    include_assets_only: Optional[List[str]] = None

    rank_by: Optional[Literal["visibility_score", "average_position"]] = None

    include_position_frequency: Optional[bool] = None
