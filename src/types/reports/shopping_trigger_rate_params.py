...
__all__ = ["ShoppingTriggerRateParams", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingTriggerRateParams(TypedDict, total=False):
    ...
    dimensions: Iterable[Literal["period", "date", "model_id", "topic_id", "region_id", "persona_id", "prompt_id", "prompt"]]

    metrics: Iterable[Literal["total_runs", "shopping_triggered_runs", "trigger_rate_percentage"]]
