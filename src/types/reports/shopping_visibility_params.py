...
__all__ = ["ShoppingVisibilityParams", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingVisibilityParams(TypedDict, total=False):
    ...
    dimensions: Iterable[Literal["period", "asset_name", "date", "model_id", "topic_id", "region_id", "prompt_id", "prompt"]]

    metrics: Iterable[Literal["visibility_score", "share_of_voice", "average_position", "visibility_rank", "average_position_rank", "position1_percentage", "position2_percentage", "position3_percentage", "position_above3_percentage", "total_count"]]
