...
__all__ = ["ShoppingMerchantShareQuery", "ProfoundShoppingApiAssetNameFilter"]
...
class ShoppingMerchantShareQuery(BaseModel):
    ...
    dimensions: Optional[List[Literal["period", "topic_id", "prompt_id"]]] = None

    metrics: Optional[List[Literal["merchant_share"]]] = None
