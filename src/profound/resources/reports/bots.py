...
from ...types.reports import bot_create_v1_v1_post_params, bot_create_v2_v2_post_params
...
class BotsResource(SyncAPIResource):
    ...
    def create_v1_v1_post(
        ...
        *,
        ...
        filters: Iterable[bot_create_v1_v1_post_params.Filter] | Omit = omit,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                bot_create_v1_v1_post_params.BotCreateV1V1PostParams,
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                bot_create_v2_v2_post_params.BotCreateV2V2PostParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncBotsResource(AsyncAPIResource):
    ...
    async def create_v1_v1_post(
        ...
        *,
        ...
        Example:
            ```python
            bot = await client.reports.bots.create_v1_v1_post(
                date_interval="day",
                dimensions=[],
                metrics=[],
                order_by={},
    ...
    async def create_v2_v2_post(
        ...
        *,
        ...
        Example:
            ```python
            bot = await client.reports.bots.create_v2_v2_post(
                date_interval="day",
                dimensions=[],
                metrics=[],
                order_by={},
