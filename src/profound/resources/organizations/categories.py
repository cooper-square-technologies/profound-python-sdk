...
class CategoriesResource(SyncAPIResource):
    ...
    def retrieve_regions(
        ...
        *,
        ...
        Returns:
            CategoryRetrieveRegionsResponse: Successful Response
    ...
    def get_citation_categories(
        ...
        *,
        ...
        Returns:
            CategoryGetCitationCategoriesResponse: Successful Response
...
class AsyncCategoriesResource(AsyncAPIResource):
    ...
    async def retrieve_regions(
        ...
        *,
        ...
        Example:
            ```python
            category = await client.organizations.categories.retrieve_regions(
                category_id="7c9e6679-7425-40de-944b-e07fc1f90ae7",
            )
            ```
        """
    ...
    async def get_citation_categories(
        ...
        *,
        ...
        Example:
            ```python
            category = await client.organizations.categories.get_citation_categories(
                category_id="7c9e6679-7425-40de-944b-e07fc1f90ae7",
            )
            ```
        """
