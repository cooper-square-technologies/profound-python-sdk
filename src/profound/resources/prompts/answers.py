...
from ...types.prompts.answer_create_v1_post_response import AnswerCreateV1PostResponse
from ...types.shared_params.pagination import Pagination
from ...types.prompts import (
    answer_create_v1_post_params,
    answer_query_v2_v2_post_params,
    answer_stream_v2_v2_stream_post_params,
)
from ...types.prompts.answer_query_v2_v2_post_response import AnswerQueryV2V2PostResponse
from ...types.shared_params.filter_node import FilterNode
from ...types.prompts.answer_stream_v2_v2_stream_post_response import AnswerStreamV2V2StreamPostResponse
...
class AnswersResource(SyncAPIResource):
    ...
    def create_v1_post(
        ...
        *,
        ...
        filters: Iterable[answer_create_v1_post_params.Filter] | Omit = omit,
        include: answer_create_v1_post_params.Include | Omit = omit,
        ...
        Returns:
            AnswerCreateV1PostResponse: Successful Response
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                answer_create_v1_post_params.AnswerCreateV1PostParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=AnswerCreateV1PostResponse,
        )
    ...
    def query_v2_v2_post(
        ...
        *,
        ...
        Returns:
            AnswerQueryV2V2PostResponse: Successful Response
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                answer_query_v2_v2_post_params.AnswerQueryV2V2PostParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=AnswerQueryV2V2PostResponse,
        )
    ...
    def stream_v2_v2_stream_post(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> Stream[AnswerStreamV2V2StreamPostResponse]:
        """
        Stream Answers V2
        ...
        Returns:
            Stream[AnswerStreamV2V2StreamPostResponse]: Server-sent events stream. Emits one `summary` event (the report `info` block) first, then one `result` event per row.
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                answer_stream_v2_v2_stream_post_params.AnswerStreamV2V2StreamPostParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=AnswerStreamV2V2StreamPostResponse,
            stream=True,
            stream_cls=Stream[AnswerStreamV2V2StreamPostResponse],
        )
...
class AsyncAnswersResource(AsyncAPIResource):
    ...
    async def create_v1_post(
        ...
        *,
        ...
        Example:
            ```python
            answer = await client.prompts.answers.create_v1_post(
                category_id="7c9e6679-7425-40de-944b-e07fc1f90ae7",
                start_date="2024-01-01T00:00:00.000Z",
                end_date="2024-01-01T00:00:00.000Z",
            )
    ...
    async def query_v2_v2_post(
        ...
        *,
        ...
        Example:
            ```python
            answer = await client.prompts.answers.query_v2_v2_post(
                category_id="7c9e6679-7425-40de-944b-e07fc1f90ae7",
                start_date="",
                end_date="",
            )
    ...
    async def stream_v2_v2_stream_post(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncStream[AnswerStreamV2V2StreamPostResponse]:
        """
        Stream Answers V2
        ...
        Returns:
            AsyncStream[AnswerStreamV2V2StreamPostResponse]: Server-sent events stream. Emits one `summary` event (the report `info` block) first, then one `result` event per row.

        Example:
            ```python
            stream = await client.prompts.answers.stream_v2_v2_stream_post(
                category_id="7c9e6679-7425-40de-944b-e07fc1f90ae7",
                start_date="",
                end_date="",
            )
        ...
        return await self._post(
            ...
            cast_to=AnswerStreamV2V2StreamPostResponse,
            stream=True,
            stream_cls=AsyncStream[AnswerStreamV2V2StreamPostResponse],
        )
