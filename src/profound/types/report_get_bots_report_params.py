...
__all__ = ["ReportGetBotsReportParams", "Filter", "FilterBotNameFilter", "FilterBotProviderFilter"]
...
Filter: TypeAlias = Union[PathFilter, FilterBotNameFilter, FilterBotProviderFilter]
