...
__all__ = ["OrganizationListCategoryPromptsV1OrgCategoriesCategoryPromptsGetParams"]


class OrganizationListCategoryPromptsV1OrgCategoriesCategoryPromptsGetParams(TypedDict, total=False):
    limit: int
