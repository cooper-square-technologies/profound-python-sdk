...
__all__ = ["OrganizationListCategoryPromptsV1OrgCategoriesCategoryPromptsGetResponse", "Info", "Data"]
...
class OrganizationListCategoryPromptsV1OrgCategoriesCategoryPromptsGetResponse(BaseModel):
    info: Info
