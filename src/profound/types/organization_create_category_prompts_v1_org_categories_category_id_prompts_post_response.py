...
from .shared.named_resource import NamedResource

__all__ = ["OrganizationCreateCategoryPromptsV1OrgCategoriesCategoryIDPromptsPostResponse", "Prompt"]
...
class OrganizationCreateCategoryPromptsV1OrgCategoriesCategoryIDPromptsPostResponse(BaseModel):
    dry_run: bool
