...
__all__ = ["OrganizationUpdateCategoryPromptsV1OrgCategoriesCategoryIDPromptsPatchParams", "Prompt"]


class OrganizationUpdateCategoryPromptsV1OrgCategoriesCategoryIDPromptsPatchParams(TypedDict, total=False):
