...
class AgentCreateParams(TypedDict, total=False):
    ...
    """ID of the organization that will own the agent.
    ...
    """Initial workflow graph for the agent's draft version.

    Optional — an agent can be created empty and have its graph filled in later.
    """
