...
class DocumentReplaceContentParams(TypedDict, total=False):
    ...
    """New markdown body for the document, replacing everything it held before.

    An empty string is valid and clears the document — nothing else warns you before
    ...
    """
    Off by default, matching the Profound app: the document's title follows the new
