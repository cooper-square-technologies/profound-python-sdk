...
__all__ = ["AccuracyCitationAnalysisV1CitationAnalysisPostResponse", "Claim", "ClaimEvidence"]
...
class AccuracyCitationAnalysisV1CitationAnalysisPostResponse(BaseModel):
    href: str
