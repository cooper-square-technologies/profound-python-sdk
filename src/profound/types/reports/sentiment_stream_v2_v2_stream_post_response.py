...
__all__ = ["SentimentStreamV2V2StreamPostResponse", "SentimentV2Info", "SentimentRow", "SentimentRowPrevious"]
...
SentimentStreamV2V2StreamPostResponse: TypeAlias = Union[SentimentV2Info, SentimentRow]
