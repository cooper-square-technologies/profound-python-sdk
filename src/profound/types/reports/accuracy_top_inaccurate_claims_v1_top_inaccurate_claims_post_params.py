...
__all__ = ["AccuracyTopInaccurateClaimsV1TopInaccurateClaimsPostParams"]


class AccuracyTopInaccurateClaimsV1TopInaccurateClaimsPostParams(TypedDict, total=False):
