...
__all__ = ["CitationStreamV2V2StreamPostResponse", "CitationsV2Info", "CitationRow"]
...
CitationStreamV2V2StreamPostResponse: TypeAlias = Union[CitationsV2Info, CitationRow]
