...
__all__ = ["ShoppingAllItemsWithMerchantsV1AllItemsWithMerchantsPostParams", "Filter"]


class ShoppingAllItemsWithMerchantsV1AllItemsWithMerchantsPostParams(TypedDict, total=False):
