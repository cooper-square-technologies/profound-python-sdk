...
__all__ = ["ReferralCreateV2V2PostParams", "Filter", "FilterReferralSourceFilter", "FilterReferralTypeFilter"]


class ReferralCreateV2V2PostParams(TypedDict, total=False):
