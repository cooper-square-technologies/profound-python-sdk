...
__all__ = ["AccuracyInaccurateClustersV1InaccurateClustersPostResponse", "Data", "DataModel"]
...
class AccuracyInaccurateClustersV1InaccurateClustersPostResponse(BaseModel):
    data: List[Data]
