...
from .shared.field_diff import FieldDiff
from .shared.named_resource_diff_list import NamedResourceDiffList

__all__ = ["OrganizationUpdateCategoryPromptsV1OrgCategoriesCategoryIDPromptsPatchResponse", "Prompt"]
...
class OrganizationUpdateCategoryPromptsV1OrgCategoriesCategoryIDPromptsPatchResponse(BaseModel):
    dry_run: bool
