...
if TYPE_CHECKING:
    from .resources import organization, prompts, reports, content, knowledge_bases, agents, organizations
...
ENVIRONMENTS: dict[str, str] = {
    ...
    "production_server": "https://api.tryprofound.com",
}

__all__ = ["ENVIRONMENTS", "Profound", "AsyncProfound", "Client", "AsyncClient", "Timeout", "Transport", "ProxiesTypes", "RequestOptions"]
...
class Profound(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        environment: Literal["production", "production_server"] | NotGiven = not_given,
    ...
    def _validate_headers(
        ...
        if isinstance(custom_headers.get("Authorization"), Omit):
            return
        raise TypeError("Could not resolve authentication method. Expected X-API-Key or Authorization to be set.")
